...
public class RequestParamController {
    ...
    public String modelAttributeV0(@RequestParam String username, @RequestParam int age){
        ...
        log.info("username = {} age = {}", username, age);
        log.info("hellodata = {}", hellodata);  //toString 만들어줌
        return "ok";
    }
    ...
    public String modelAttributeTest(TestData testdata){
        log.info("username={} age={}", testdata.getName(), testdata.getAge());  //Data class의 필드명과 쿼리 파라미터의 변수명이 동일해야 함
